account_invoice_import_ar
=========================

The Tryton `account_invoice_import_ar` module add wizard to import supplier invoices.
...
questions on the module bug tracker:
  ...
  https://github.com/tryton-ar/account_invoice_import_ar/issues
